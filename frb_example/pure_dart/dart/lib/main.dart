...
void main(List<String> args) async {
  ...
  group('async fn', () {
    test('dart call handle_async_fn', () async {
      expect(await api.handleAsyncFn(a: 42, b: 100), 142);
    });
    test('dart call handle_async_fn_fallible', () async {
    ...
    test('dart call SumWith::sum_async_fallible', () async {
      final SumWith sumWith = SumWith(bridge: api, x: 3);
